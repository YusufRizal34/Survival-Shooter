...
{
    [Header("PLAYER HEALTH CONTROLLER")]
    ...
    [Header("POTION CONTROLLER")]
    public int hPotionValue = 20;
    ...
    private void OnCollisionEnter(Collision other)
    {
        if (other.gameObject.tag == "HealthPotion")
        {
            if(currentHealth < 100){
                int checkCurrent = currentHealth + hPotionValue;
                currentHealth = Mathf.Clamp(checkCurrent, 0, startingHealth);
                healthSlider.value = currentHealth;
            }
